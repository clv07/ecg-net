"""
Proposed Model v4: Multi-scale Per-lead CNN + Spatial Lead Attention
=====================================================================
Our method (vs classmate's v2 single-scale per-lead CNN + lead attention).

Run:
    python proposed_model_v4.py
"""
...
from device import get_device, pin_memory_enabled, dataloader_num_workers
